...
const Navbar = () => {
  ...
  return (
      <div className="fixed w-full mb-12 z-10 navbar py-2  bg-black bg-opacity-25 backdrop-blur-[1px] max-sm:px-8">
        <Container>
          <>
            <div className=" md:flex justify-between items-center">
              <div className="navbar flex justify-between items-center">
                ...
                >
                  ...
                  />
                  <p className="font-bold text-green-600 text-lg md:text-xl lg:text-2xl">
                    Tourza
                  </p>
                </Link>
